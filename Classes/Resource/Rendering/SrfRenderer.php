 ...
 * Srf renderer class
 */
class SrfRenderer implements FileRendererInterface
{
    /**
    ...
    {
        return ($file->getMimeType() === 'video/srf' || $file->getExtension() === 'srf') && $this->getOnlineMediaHelper($file) !== false;
    }
    ...
    public function render(FileInterface $file, $width, $height, array $options = [], $usedPathsRelativeToCurrentScript = false)
    {
        ...
        $src = $this->createSrfUrl($options, $file);
     ...
     * @return string
     */
    protected function createSrfUrl(array $options, FileInterface $file)
    {
