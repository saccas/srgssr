...
final class RtrRendererTest extends AbstractFunctionalWithFileExtensionTestCase
{
    #[Test]
    ...
    public function canCreateUrlWithoutOptions(): void
    {
        ...
        self::assertSame(
            '//tp.srgssr.ch/p/rtr/embed?urn=urn:rtr:video:051820c8-731f-4b46-b5d0-0f2111a55e72&',
            $url
        );
    }
    ...
    public function canCreateUrlWithAutoplayOption(): void
    {
        ...
        self::assertSame(
            '//tp.srgssr.ch/p/rtr/embed?urn=urn:rtr:video:051820c8-731f-4b46-b5d0-0f2111a55e72&autoplay=true',
            $url
        );
    }
    ...
    public function rendersFileWithMinimumOfOptions(): void
    {
        ...
        self::assertSame(
            '<iframe src="//tp.srgssr.ch/p/rtr/embed?urn=urn:rtr:video:051820c8-731f-4b46-b5d0-0f2111a55e72&" allowfullscreen width="200" height="300" fullscreen></iframe>',
            $rendered
        );
    }
    ...
    public function rendersFileWithAutoplayActiveFromFileReference(): void
    {
        ...
        self::assertSame(
            '<iframe src="//tp.srgssr.ch/p/rtr/embed?urn=urn:rtr:video:051820c8-731f-4b46-b5d0-0f2111a55e72&autoplay=true" allowfullscreen width="200" height="300" autoplay; fullscreen></iframe>',
            $rendered
        );
    }
    ...
    public function rendersFileWithAllowFromOptions(): void
    {
        ...
        self::assertSame(
            '<iframe src="//tp.srgssr.ch/p/rtr/embed?urn=urn:rtr:video:051820c8-731f-4b46-b5d0-0f2111a55e72&" allowfullscreen width="200" height="300" autoplay; fullscreen; custom;></iframe>',
            $rendered
        );
    }
    ...
    public function rendersFileWithAdditionalAttributes(): void
    {
        ...
        self::assertSame(
            '<iframe src="//tp.srgssr.ch/p/rtr/embed?urn=urn:rtr:video:051820c8-731f-4b46-b5d0-0f2111a55e72&" allowfullscreen attribute="value" width="200" height="300" fullscreen></iframe>',
            $rendered
        );
    }
    ...
    public function rendersFileWithDataAttributes(): void
    {
        ...
        self::assertSame(
            '<iframe src="//tp.srgssr.ch/p/rtr/embed?urn=urn:rtr:video:051820c8-731f-4b46-b5d0-0f2111a55e72&" allowfullscreen data-attribute="value" width="200" height="300" fullscreen></iframe>',
            $rendered
        );
    }
