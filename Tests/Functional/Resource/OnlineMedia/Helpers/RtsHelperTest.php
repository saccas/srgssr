...
#[CoversClass(RtsHelper::class)]
final class RtsHelperTest extends AbstractFunctionalTestCase
{
    #[Test]
    ...
    public function returnsPublicUrl(): void
    {
        ...
        self::assertSame(
            'https://www.rts.ch/play/tv/video/?id=051820c8-731f-4b46-b5d0-0f2111a55e72',
    ...
    public function returnsPreviewImageForChapter(): void
    {
        ...
        self::assertSame($this->instancePath . '/typo3temp/assets/online_media/rts_6c96f01771abd561078ce103532b124f.jpg', $result);
    ...
    public function transformsUrlToFileWithMissingQuery(): void
    {
        ...
        $result = $subject->transformUrlToFile('https://www.rts.ch', $this->getUploadFolder());
    ...
    public function transformsUrlToFileWithMissingUrn(): void
    {
        ...
        $result = $subject->transformUrlToFile('https://www.rts.ch?other=1', $this->getUploadFolder());
    ...
    public function transformsUrlToFileWhenFileExists(): void
    {
        $result = $this->get(OnlineMediaHelperRegistry::class)->transformUrlToFile(
            'https://www.rts.ch/play/tv/abstimmungen/video/praesidentenrunde-zur-abstimmung-vom-30-11-2025?urn=urn:rts:video:3186a7cb-1cba-4e73-b764-e65e4826e194',
    ...
    public function transformsUrlToFileWhenFileDoesNotExist(): void
    {
        ...
        $result = $this->get(OnlineMediaHelperRegistry::class)->transformUrlToFile(
            'https://www.rts.ch/play/tv/abstimmungen/video/praesidentenrunde-zur-abstimmung-vom-30-11-2025?urn=urn:rts:video:3186a7cb-1cba-4e73-b764-e65e4826e195',
            $this->getUploadFolder(),
            ['rts']
        );
        ...
        self::assertSame('Präsidentenrunde_zur_Abstimmung_vom_30.11.2025.rts', $result->getName());
        self::assertSame('rts', $result->getExtension());
