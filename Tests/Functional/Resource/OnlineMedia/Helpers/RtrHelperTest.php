...
#[CoversClass(RtrHelper::class)]
final class RtrHelperTest extends AbstractFunctionalTestCase
{
    #[Test]
    ...
    public function returnsPublicUrl(): void
    {
        ...
        self::assertSame(
            'https://www.rtr.ch/play/tv/video/?id=051820c8-731f-4b46-b5d0-0f2111a55e72',
    ...
    public function returnsPreviewImageForChapter(): void
    {
        ...
        self::assertSame($this->instancePath . '/typo3temp/assets/online_media/rtr_6c96f01771abd561078ce103532b124f.jpg', $result);
    ...
    public function transformsUrlToFileWithMissingQuery(): void
    {
        ...
        $result = $subject->transformUrlToFile('https://www.rtr.ch', $this->getUploadFolder());
    ...
    public function transformsUrlToFileWithMissingUrn(): void
    {
        ...
        $result = $subject->transformUrlToFile('https://www.rtr.ch?other=1', $this->getUploadFolder());
    ...
    public function transformsUrlToFileWhenFileExists(): void
    {
        $result = $this->get(OnlineMediaHelperRegistry::class)->transformUrlToFile(
            'https://www.rtr.ch/play/tv/abstimmungen/video/praesidentenrunde-zur-abstimmung-vom-30-11-2025?urn=urn:rtr:video:3186a7cb-1cba-4e73-b764-e65e4826e194',
    ...
    public function transformsUrlToFileWhenFileDoesNotExist(): void
    {
        ...
        $result = $this->get(OnlineMediaHelperRegistry::class)->transformUrlToFile(
            'https://www.rtr.ch/play/tv/abstimmungen/video/praesidentenrunde-zur-abstimmung-vom-30-11-2025?urn=urn:rtr:video:3186a7cb-1cba-4e73-b764-e65e4826e195',
            $this->getUploadFolder(),
            ['rtr']
        );
        ...
        self::assertSame('Präsidentenrunde_zur_Abstimmung_vom_30.11.2025.rtr', $result->getName());
        self::assertSame('rtr', $result->getExtension());
